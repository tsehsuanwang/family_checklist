            ...
            <article key={routine.id} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <span className={`mb-2 inline-flex rounded-full px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide ${routine.routine_type === "math" ? "bg-amber-100 text-amber-700" : "bg-slate-100 text-slate-600"}`}>
                    {routine.routine_type === "math" ? "Math" : "Checklist"}
                  </span>
